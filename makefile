...
CFLAGS=-DBIGARRAY_MULTIPLIER=1 -Wall -Werror -Wno-unknown-pragmas -fno-stack-protector -DTARGET_IA32 -DHOST_IA32 -DTARGET_LINUX  -I$(PINDIR)/source/include/pin -I$(PINDIR)/source/include/pin/gen -I$(PINDIR)/extras/components/include -I$(PINDIR)/extras/xed2-ia32/include -I$(PINDIR)/source/tools/InstLib -O3 -fomit-frame-pointer -fno-strict-aliasing  
